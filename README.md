# [SOLVED] Err-Unsafe-Port-Error-On-Chrome-When-Browsing-To-Unsafe-Port
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/err-unsafe-port-error-on-chrome-when-browsing-to-unsafe-port)
>
...
Try using the Chrome flag '--allow-unsecure-ports' or add an exception in Chrome's settings to allow access to port 6666.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/err-unsafe-port-error-on-chrome-when-browsing-to-unsafe-port)**
